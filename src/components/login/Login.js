...
import animation from '../../assets/animationimages/animation.gif'
import logo from '../../assets/images/logo.png'
import { ToastError, ToastSuccess } from "../../middleware/ToastModel";
import {useDispatch,useSelector} from 'react-redux';
import { LoginUserAction } from "../../redux/reducers/Login_Reducer";
...
const Login = memo(() => {
  ...
  const handleSubmitUser = async (e) => {
    ...
    if (email && password) {
      ...
      const datas = { email, password,role:"admin" };
      try {
      ...
      <div className="singin-main-section">
        <div className="inside-section-main">
          <div className="left-section-signin d-md-block d-none">
            <img src={animation} alt="no image" className="logo2" />
          </div>
              ...
              <img src={logo} alt="no image" className="logo1" />
                ...
                <div className="mt-3">
                    ...
                    <div className="button-signin-sections mt-3">
                      <button className="submit-btn" onClick={handleSubmitUser}>
                        {formState ? (
                          <>
                            <Spinner
                              as="span"
